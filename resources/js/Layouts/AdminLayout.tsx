...
const NAV_ITEMS = [
    ...
    { route: 'admin.nfc-tags.index',  label: 'NFC matricák',  icon: 'M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 4h8a2 2 0 012 2v6a2 2 0 01-2 2h-8a2 2 0 01-2-2v-6a2 2 0 012-2z' },
