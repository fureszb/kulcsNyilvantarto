...
export default function SecurityLeadLayout({ children, title }: Props) {
    ...
    const navLinks = [
        ...
        {
            route: 'security-lead.messages',
            label: 'Igazgatói üzenetek',
            icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z',
            matchRoute: 'security-lead.messages',
        },
        {
        ...
        {
            route: 'security-lead.reports',
            label: 'Napi Jelentés',
            icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z',
            matchRoute: 'security-lead.reports*',
        },
        {
        ...
        {
            route: 'security-lead.inventory',
            label: 'Leltár',
            icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4',
            matchRoute: 'security-lead.inventory',
        },
        {
            route: 'ai.chat',
            label: 'AI',
                        ...
                        <div className="flex items-center justify-between h-14">
                            ...
                            <Link href={route('security-lead.dashboard')} className="flex items-center gap-3 group shrink-0">
                                ...
                                <div className="leading-tight">
                                    <span className="text-sm font-bold text-white block hover:text-cyan-400 transition-colors">{tenantName}</span>
                                    <span className="text-xs text-cyan-400 font-semibold uppercase tracking-wider">Biztonsági Vezető</span>
                                </div>
                            </Link>
