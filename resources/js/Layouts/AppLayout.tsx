                        ...
                        <nav className="hidden sm:flex items-center gap-0.5">
                            {[
                                ...
                                <Link key={nl.href} href={nl.href}
                                    className={`relative flex items-center gap-1.5 px-3 py-2 rounded-full text-xs font-medium transition-colors ${nl.active ? 'bg-white/20 text-white' : 'text-white/70 hover:text-white hover:bg-white/10'}`}>
                    ...
                    <div className="sm:hidden border-t border-white/10 px-4 py-3 space-y-1">
                        {[
                            ...
                            <Link key={nl.href} href={nl.href} onClick={() => setMobileOpen(false)}
                                className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all ${nl.active ? 'bg-white/20 text-white' : 'text-white/70 hover:text-white hover:bg-white/10'}`}>
