...
import type { SecurityDailyReport } from '../../types';
...
export default function PmSecurityShow({ report }: Props) {
    ...
    return (
        <PmLayout title={`Napi Jelentés – ${report.report_date}`}>
            {/* Hero */}
            <div className="relative overflow-hidden rounded-2xl mb-8 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 shadow-xl">
                ...
                <div className="absolute -bottom-12 -left-12 w-40 h-40 bg-amber-700/10 rounded-full blur-3xl pointer-events-none" />
                ...
                <div className="relative px-4 py-6 sm:px-8 sm:py-8 flex items-start justify-between gap-6 flex-wrap">
                    ...
                    <div className="flex items-center gap-2.5 shrink-0 flex-wrap">
                        <a href={route('pm.security')} className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 text-slate-300 hover:text-white text-sm font-medium transition-colors">
