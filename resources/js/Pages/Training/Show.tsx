                        ...
                        {step.media_url && (
                            <div className="rounded-xl overflow-hidden bg-slate-100 flex items-center justify-center relative group">
                                {step.media_type !== 'video' ? (
                                    ...
                                    <video src={step.media_url} style={{ width: `${step.media_width ?? 100}%` }} className="max-h-[32rem] object-contain" controls autoPlay loop />
                                )}
                                {(step.media_type !== 'video' || isCorrect) && (
                                    <button
                                        type="button"
                        ...
                        {step.reveal_url && isCorrect && (
                            <div className="rounded-xl overflow-hidden border-2 border-green-300 bg-green-50">
                                ...
                                {step.reveal_type === 'video' ? (
                                    <video src={step.reveal_url} style={{ width: `${step.reveal_media_width ?? 100}%` }} className="max-h-96 object-contain" autoPlay loop controls />
                                ) : (
