            ...
            <div className="-mx-4 sm:-mx-6 lg:-mx-8 relative overflow-hidden rounded-2xl mb-8 shadow-2xl"
                ...
                <div className="relative z-10 px-8 py-8 flex items-center justify-between gap-6">
                    <div>
                        ...
                        <h1 className="text-3xl font-extrabold text-white tracking-tight">Leltár</h1>
                        <p className="text-slate-400 mt-1 text-sm">Kulcsok és belépőkártyák a saját irodaházaidban — {locations.length} irodaház</p>
                    </div>
