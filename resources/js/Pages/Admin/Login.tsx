...
export default function AdminLogin() {
    ...
    const tenantName = tenant?.name ?? 'Kulcs & Kártya Nyilvántartó';
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-4 relative overflow-hidden">
            ...
            <div className="relative w-full max-w-sm">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-2xl font-extrabold text-white tracking-tight">Admin belépés</h1>
                ...
                <div className="bg-white rounded-2xl shadow-2xl shadow-black/30 border border-white/10 p-6">
                    ...
                    {flash.success && (
                        <div className="mb-4 flex items-center gap-2.5 p-3 bg-emerald-50 border border-emerald-200 text-emerald-700 rounded-xl text-sm">
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        ...
                        >
                            ...
                            {processing ? 'Belépés...' : 'Belépés'}
                        </button>
                    </form>
                </div>

                <p className="text-center mt-5">
                    <a href={route('login')} className="text-sm text-slate-500 hover:text-slate-300 transition-colors">
                        ← Vissza a belépéshez
                    </a>
                </p>
