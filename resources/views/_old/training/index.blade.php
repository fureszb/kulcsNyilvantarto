    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div class="group relative overflow-hidden bg-white border border-slate-200 rounded-2xl shadow-sm
            ...
            <div class="p-6 flex flex-col flex-1">
                ...
                <h2 class="text-base font-bold text-slate-800 leading-tight">{{ $training->title }}</h2>
                ...
                <div class="mt-5 pt-4 border-t border-slate-100">
                    <div class="flex items-center gap-1.5 mb-3">
                        ...
                        <span class="text-xs font-medium text-slate-400">{{ $training->steps_count }} kérdés</span>
                    </div>
                    <a href="{{ route('training.show', $training) }}"
                       class="flex items-center justify-center gap-1.5 px-3 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-xl transition-colors w-full">
