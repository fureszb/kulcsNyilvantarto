      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr>
          <td style="background-color:#0f172a;border-radius:16px 16px 0 0;padding:28px 36px;">
            ...
            <h1 style="margin:0;font-size:22px;font-weight:800;color:#ffffff;line-height:1.3;">Új üzenet érkezett</h1>
            <p style="margin:6px 0 0;font-size:13px;color:#64748b;">Property Manager közvetlen üzenete</p>
          </td>
        </tr>

        {{-- SENDER BANNER --}}
        <tr>
          <td style="background-color:#fffbeb;border-left:4px solid #f59e0b;padding:14px 36px;">
            <p style="margin:0;font-size:13px;color:#92400e;">
              <strong>{{ $senderName }}</strong> üzenetet küldött Önnek, <strong>{{ $recipientName }}</strong>.
            </p>
          </td>
        </tr>
        ...
        <tr>
          <td style="background-color:#ffffff;padding:28px 36px;border-left:1px solid #e2e8f0;border-right:1px solid #e2e8f0;">
            ...
            <div style="background:#fffbeb;border:1px solid #fde68a;border-radius:12px;padding:18px 20px;margin-bottom:28px;">
              <p style="margin:0;font-size:14px;color:#1e293b;line-height:1.7;white-space:pre-line;">{{ $messageContent }}</p>
            </div>

            <p style="margin:0 0 16px;font-size:13px;color:#64748b;text-align:center;">
              Az üzenetre való válaszhoz jelentkezzen be a rendszerbe:
            </p>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center">
                  <a href="{{ $loginUrl }}"
                     style="display:inline-block;background-color:#f59e0b;color:#ffffff;font-size:14px;font-weight:700;text-decoration:none;padding:13px 32px;border-radius:10px;letter-spacing:.02em;">
